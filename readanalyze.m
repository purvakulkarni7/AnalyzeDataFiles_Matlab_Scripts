function [fileName, imgData, mzData] = readanalyze()
...
if RESHAPE_DATA
  ...
  switch dimension(1)
    case 4
      % 4-dimensional data
      if dimension(5) == 1
	imgData = reshape(imgData,dimension(2),dimension(3),dimension(4));
	if FLIP_DATA
	  imgData = flipdim(imgData,1);
    ...
    case 2
      % 2-dimensional data
      imgData = reshape(imgData,dimension(2),dimension(3));
    case 1
      % 1-d data
    otherwise
